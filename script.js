...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const learnProgrammingBtn = document.getElementById('learnProgrammingBtn'); // НОВАЯ КНОПКА
    const showOutputBtn = document.getElementById('showOutputBtn');
    const toggleHeaderBtn = document.getElementById('toggleHeaderBtn');

    const addModal = document.getElementById('addModal');
    const settingsModal = document.getElementById('settingsModal');
    const closeModalBtns = document.querySelectorAll('.close-modal-btn'); // Кнопки закрытия модальных окон
    ...
    const learningPanel = document.getElementById('learningPanel'); // НОВАЯ ПАНЕЛЬ
    const closeLearningPanelBtn = document.getElementById('closeLearningPanelBtn'); // КНОПКА ЗАКРЫТИЯ ПАНЕЛИ
    ...
    function updateBlurEffect() {
        ...
        if (anyModalActive || learningPanelActive) {
    ...
    // --- Функции для модальных окон и панели обучения ---
    ...
    function applyTheme(theme) {
        ...
        // Обновляем цвет нижней границы активной вкладки
    ...
    learnProgrammingBtn.addEventListener('click', openLearningPanel); // НОВЫЙ ОБРАБОТЧИК
    clearBtn.addEventListener('click', () => {
        if (confirm('Вы уверены, что хотите очистить все поля? Это действие необратимо.')) {
            htmlEditor.setValue('');
            cssEditor.setValue('');
            jsEditor.setValue('');
            // Monaco events will trigger updateOutput and localStorage save
        }
    });
    ...
    function toggleHeaderVisibility() {
        ...
        // Обновляем текст кнопки в заголовке
        toggleHeaderBtn.textContent = isHidden ? 'Показать панель' : 'Скрыть панель';
    ...
    // Обработчики для кнопок скрытия/показа панели
    ...
    closeLearningPanelBtn.addEventListener('click', closeLearningPanel); // НОВЫЙ ОБРАБОТЧИК

    // --- Закрытие модальных окон и панели обучения при клике вне содержимого ---
    const allOverlays = document.querySelectorAll('.modal-overlay, .learning-panel');
